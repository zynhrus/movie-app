...
class _FavoritePageState extends State<FavoritePage> {
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return favoriteMovieItem(
                      context, favoriteMovie, database, movie);
                },
              ),
            );
          } else {
  ...
  Widget favoriteMovieItem(BuildContext context, FavoriteMovie favoriteMovie,
      DatabaseFavoriteMovie database, Movie movie) {
